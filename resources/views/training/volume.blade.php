<x-app-layout>
    <x-slot name="header">
        <div>
            <h1 class="telemetry-value text-4xl sm:text-5xl">{{ __('Training Volume') }}</h1>
            <p class="mt-2 text-sm font-medium text-telemetry-slate">Volume latihan mingguan & bulanan dari data Garmin.</p>
        </div>
    </x-slot>
