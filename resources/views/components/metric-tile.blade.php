...
<div {{ $attributes->merge(['class' => 'bg-telemetry-surface border border-telemetry-line p-3 sm:p-4']) }}>
    ...
    <p class="mt-2 text-2xl leading-none telemetry-value sm:mt-2.5 sm:text-[28px]">
