<x-app-layout>
    <x-slot name="header">
        <div>
            <h1 class="telemetry-value text-2xl sm:text-3xl lg:text-5xl">{{ __('Running Records') }}</h1>
            <p class="mt-1 text-sm font-medium text-telemetry-slate">Personal records dan lari terjauh kamu.</p>
        </div>
    </x-slot>
