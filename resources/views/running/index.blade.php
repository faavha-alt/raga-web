<x-app-layout>
    <x-slot name="header">
        <div>
            <h1 class="telemetry-value text-2xl sm:text-3xl lg:text-5xl">{{ __('Running') }}</h1>
            <p class="mt-1 text-sm font-medium text-telemetry-slate">Ringkasan performa lari kamu dari data Garmin.</p>
        </div>
    </x-slot>
