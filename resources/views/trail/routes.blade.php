<x-app-layout>
    <x-slot name="header">
        <div>
            <h1 class="telemetry-value text-2xl sm:text-3xl lg:text-5xl">{{ __('Perbandingan Rute') }}</h1>
            <p class="mt-1 text-sm font-medium text-telemetry-slate">Performa kamu di rute trail yang sudah dilari berulang kali.</p>
        </div>
    </x-slot>
